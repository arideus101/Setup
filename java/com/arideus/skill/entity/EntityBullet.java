...
public class EntityBullet extends Entity implements IProjectile {
	...
	public EntityBullet(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_,
			float p_i1755_5_) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityBullet(World worldIn, EntityLivingBase shooter, float p_i1756_3_, Item Ammo, int Type) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = shooter;
		...
		if (this.inGround) {
			...
			if (block == this.inTile && j == this.inData) {
				...
				if (list.size() > 0) {
					this.setDead();
					if (this.ammo != null)
						((EntityPlayer) list.get(0)).inventory.addItemStackToInventory(new ItemStack(this.ammo));
				}
