...
public class EntityBulletChisel extends Entity implements IProjectile {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public EntityBulletChisel(World worldIn) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityBulletChisel(World worldIn, double x, double y, double z) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityBulletChisel(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_,
			float p_i1755_5_) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public EntityBulletChisel(World worldIn, EntityLivingBase shooter, float p_i1756_3_) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = shooter;
	...
	public EntityBulletChisel(World worldIn, EntityLivingBase shooter, float p_i1756_3_, Item Ammo, int Type) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = shooter;
	...
	public void onUpdate() {
		...
		if (block == Blocks.cobblestone || block == Blocks.stonebrick || block == Blocks.gravel
				|| block == Blocks.stone) {
			worldObj.setBlockState(blockpos, Blocks.stonebrick.getDefaultState());
		}
				...
				if (movingobjectposition.entityHit != null) {
					...
					if (this.shootingEntity == null) {
						if (this.BulletType == 0)
							damagesource = Main.causeBulletDamage(this, this);

					} else {
						if (this.BulletType == 0)
							damagesource = Main.causeBulletDamage(this, this.shootingEntity);
					...
					if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float) k)) {
						if (movingobjectposition.entityHit instanceof EntityLivingBase) {
							...
							if (this.BulletType == 3) {
								entitylivingbase.addPotionEffect(new PotionEffect(Potion.poison.getId(), 300, 1));
								entitylivingbase.addPotionEffect(new PotionEffect(Potion.wither.getId(), 60, 1));
								entitylivingbase.addPotionEffect(new PotionEffect(Potion.moveSlowdown.getId(), 300, 1));
								entitylivingbase.addPotionEffect(new PotionEffect(Potion.weakness.getId(), 300, 1));
								entitylivingbase.addPotionEffect(new PotionEffect(Potion.blindness.getId(), 100, 1));
							}
