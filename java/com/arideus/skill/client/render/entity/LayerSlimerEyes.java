...
public class LayerSlimerEyes implements LayerRenderer
{
    private static final ResourceLocation field_177150_a = new ResourceLocation("skill:textures/entity/spider_eyes.png");
    private final RenderSlimer field_177149_b;
    private static final String __OBFID = "CL_00002410";

    public LayerSlimerEyes(RenderSlimer p_i46109_1_)
    {
        this.field_177149_b = p_i46109_1_;
    }

    public void func_177148_a(EntitySlimer p_177148_1_, float p_177148_2_, float p_177148_3_, float p_177148_4_, float p_177148_5_, float p_177148_6_, float p_177148_7_, float p_177148_8_)
    {
    ...
    {
        this.func_177148_a((EntitySlimer)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
    }
}